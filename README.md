...
| **Rush Radar** | Credits each new block to the enemy standing beside it, and flags runs that are long, straight, still growing and aimed at your island. Finds your island's outline itself by walking out from your bed over solid ground, stopping where bridges begin, and times each rush to that edge. A rush gets one toast and ping when it starts and a red toast and higher ping five seconds out, with nothing repeated in between. While it lasts, an arrow beside the crosshair points the way to turn to face the bridge, with the seconds left. **Show Island** outlines what it found |
